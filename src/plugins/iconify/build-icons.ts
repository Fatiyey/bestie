...
import { fileURLToPath } from 'node:url'; // Ditambahkan
...
const __filename = fileURLToPath(import.meta.url); // Ditambahkan
const __dirname = dirname(__filename); // Ditambahkan
...
;(async function () {
  ...
  if (sources.icons) {
    ...
    for (const prefix in organizedList) {
      const filename = require.resolve(`@iconify/json/json/${prefix}.json`) // Menggunakan require yang sudah didefinisikan
